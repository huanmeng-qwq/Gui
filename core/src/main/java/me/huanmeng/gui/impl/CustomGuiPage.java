 ...
 * and manage multiple {@link me.huanmeng.gui.impl.page.PageArea}s, each with its own set of items, slots, and pagination
 * settings.
 *
 * <p>
 ...
 * @see AbstractGuiPage
 * @see GuiPage
 * @see me.huanmeng.gui.impl.page.PageArea
 */
