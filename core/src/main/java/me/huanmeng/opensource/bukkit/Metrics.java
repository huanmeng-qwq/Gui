 ...
 */
package me.huanmeng.opensource.bukkit;
...
public class Metrics {
     ...
     */
    public Metrics(Plugin plugin, int serviceId, String version) {
        this.plugin = plugin;
    ...
    private void appendServiceData(JsonObjectBuilder builder) {
        builder.appendField("pluginVersion", this.version!=null ? this.version : plugin.getDescription().getVersion());
    }
